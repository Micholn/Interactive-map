...
const ecosystem = {
    nodes: [
        {
            ...
            sources: [
                {
                    label: 'OpenAI GPT-4 announcement',
        ...
        },
        {
            ...
            name: 'OpenAI',
            category: 'lab',
            description: 'AI research and deployment company behind GPT models, ChatGPT and major API products.',
            centrality: 95,
            tags: [
                'AI lab',
                'Frontier AI',
        ...
        },
        {
            ...
            name: 'Anthropic',
            category: 'lab',
            description: 'AI safety-focused company developing the Claude model family.',
            centrality: 87,
            tags: [
                'AI lab',
                'Safety',
        ...
        },
        {
            ...
            name: 'Meta',
            category: 'lab',
            description: 'Technology company behind LLaMA and a major contributor to the PyTorch ecosystem.',
            centrality: 91,
            tags: [
                'Open weights',
                'PyTorch',
        ...
        },
        {
            ...
            category: 'lab',
            description: 'Google’s AI research lab behind Gemini and major AI research systems.',
            centrality: 93,
            tags: [
                'AI lab',
                'Gemini',
        ...
        },
        {
            ...
            name: 'Mistral AI',
            category: 'lab',
            description: 'European AI company building open-weight and commercial LLMs.',
            centrality: 74,
            tags: [
                'AI lab',
                'Europe',
        ...
        },
        {
            ...
            name: 'xAI',
            category: 'lab',
            description: 'AI company developing Grok and associated reasoning systems.',
            centrality: 71,
            tags: [
                'AI lab',
                'Grok',
        ...
        },
        {
            ...
            name: 'Cohere',
            category: 'lab',
            description: 'Enterprise AI company focused on language models, retrieval and business workflows.',
            centrality: 69,
            tags: [
                'Enterprise AI',
                'RAG',
        ...
        },
        {
            ...
            name: 'Stability AI',
            category: 'lab',
            description: 'AI company associated with image generation and the Stable Diffusion ecosystem.',
            centrality: 67,
            tags: [
                'Image AI',
                'Diffusion',
        ...
        },
        {
            ...
            name: 'PyTorch',
            category: 'framework',
            description: 'Widely used machine learning framework originally developed by Meta and used heavily in AI research and training.',
            centrality: 94,
            tags: [
                'Framework',
                'Training',
        ...
        },
        {
            ...
            name: 'TensorFlow',
            category: 'framework',
            description: 'Machine learning framework developed by Google, used for production ML and research workflows.',
            centrality: 81,
            tags: [
                'Framework',
                'Production ML',
        ...
        },
        {
            ...
            name: 'JAX',
            category: 'framework',
            description: 'High-performance numerical computing and machine learning framework used in advanced AI research.',
            centrality: 84,
            tags: [
                'Framework',
                'Research',
        ...
        },
        {
            ...
            name: 'CUDA',
            category: 'framework',
            description: 'NVIDIA parallel computing platform that underpins many GPU-accelerated AI workloads.',
            centrality: 96,
            tags: [
                'GPU software',
                'Acceleration',
        ...
        },
        {
            ...
            category: 'compute',
            description: 'Cloud computing platform deeply connected to OpenAI infrastructure and AI hosting.',
            centrality: 96,
            tags: [
                'Cloud',
                'Compute',
        ...
        },
        {
            ...
            name: 'AWS',
            category: 'compute',
            description: 'Major cloud provider used across AI training, hosting and inference workloads.',
            centrality: 89,
            tags: [
                'Cloud',
                'Compute',
        ...
        },
        {
            ...
            name: 'Google Cloud',
            category: 'compute',
            description: 'Google cloud infrastructure supporting AI workloads and TPU access.',
            centrality: 88,
            tags: [
                'Cloud',
                'TPU',
        ...
        },
        {
            ...
            name: 'Oracle Cloud',
            category: 'compute',
            description: 'Cloud infrastructure provider with AI training and GPU services.',
            centrality: 64,
            tags: [
                'Cloud',
                'GPU',
        ...
        },
        {
            ...
            name: 'NVIDIA',
            category: 'hardware',
            description: 'Dominant GPU provider powering much of modern AI training and inference.',
            centrality: 99,
            tags: [
                'GPU',
                'H100',
        ...
        },
        {
            ...
            name: 'Google TPU',
            category: 'hardware',
            description: 'Google’s tensor processing infrastructure for large-scale AI workloads.',
            centrality: 82,
            tags: [
                'Accelerator',
                'Google',
        ...
        },
        {
            ...
            name: 'AMD Instinct',
            category: 'hardware',
            description: 'AMD accelerator platform used as an alternative GPU stack for AI training and inference.',
            centrality: 68,
            tags: [
                'GPU',
                'Accelerator',
        ...
        },
        {
            ...
            name: 'Transformers',
            category: 'repository',
            description: 'Popular open-source library for model loading, training and inference.',
            centrality: 90,
            tags: [
                'Open source',
                'Models',
        ...
        },
        {
            ...
            name: 'vLLM',
            category: 'repository',
            description: 'High-throughput LLM inference and serving library widely used for production inference.',
            centrality: 77,
            tags: [
                'Inference',
                'Serving',
        ...
        },
        {
            ...
            name: 'LangChain',
            category: 'repository',
            description: 'Framework for building applications around language models, tools, chains and retrieval.',
            centrality: 79,
            tags: [
                'Apps',
                'Agents',
    ...
    links: [
        ...
        },
        {
            ...
            target: 'anthropic',
            type: 'partners_with',
            label: 'competes/benchmarks against'
        },
        {
            source: 'llama',
            target: 'mistral',
            type: 'fine_tuned_from',
            label: 'influences open model ecosystem'
        }
    ]
};
}),
"[project]/components/InteractiveEcosystemGraph.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InteractiveEcosystemGraph({ nodes, activeCategory, onNodeClick }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ForceGraph2D, {
            graphData: graphData,
            width: undefined,
            height: 520,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$InteractiveEcosystemGraph$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/InteractiveEcosystemGraph.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: week.map((d, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$ecosystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ecosystem"].links?.length ?? 0
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/page.tsx",
                                                                            lineNumber: 183,
                                                                            columnNumber: 23
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$InteractiveEcosystemGraph$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                    nodes: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$ecosystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ecosystem"].nodes,
...
//# sourceMappingURL=_0l1_7ei._.js.map